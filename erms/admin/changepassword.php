...
<body id="page-top">
  ...
  <?php include_once('includes/sidebar.php')?>
    ...
    <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column"style="background-color:black;color:light">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-light-800">Change Password</h1>
...
<?php } ?>
                    <div class="row" style="margin-top:4%">
                      <div class="col-4"></div>
                      <div class="col-4">
                      <input type="submit" name="submit"  value="Change" class="btn btn-success btn-user btn-block">
                    </div>
                    </div>
