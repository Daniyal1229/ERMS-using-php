  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5"style="border-radius:25px;background-color:black">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-lg-900 mb-4">Admin login!</h1>
                  </div>
                  <form class="user" method="post" action="">
                    ...
                    <hr>
                    <hr>
                    <p> <input type="submit" class="btn btn-success btn-user btn-block" name="login" value="login"></p>
